...
- Module: `runtime`
- Current symbol: `getRotEncSpeed`
- Doc id: `runtime.get-rot-enc-speed`
- Source: `radio/src/lua/api_general.cpp:858`
...
<div class="decision-panel" data-item-id="getRotEncSpeed">
...
@retval (integer) in list: ROTENC_LOWSPEED, ROTENC_MIDSPEED, ROTENC_HIGHSPEED returns ROTENC_LOWSPEED on radio without rotary encoder
