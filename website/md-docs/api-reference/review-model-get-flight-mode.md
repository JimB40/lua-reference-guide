# Review: model.getFlightMode

[Back to dashboard](review.md) | [Open API page](model-functions/model-get-flight-mode.md)

## Snapshot

- Module: `model`
- Current symbol: `model.getFlightMode`
- Doc id: `model.get-flight-mode`
- Source: `radio/src/lua/api_model.cpp:470`
...
<div class="decision-panel" data-item-id="model.getFlightMode">
