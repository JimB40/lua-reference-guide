...
- Module: `model`
- Current symbol: `model.getMixesCount`
- Doc id: `model.get-mixes-count`
- Source: `radio/src/lua/api_model.cpp:808`
...
<div class="decision-panel" data-item-id="model.getMixesCount">
...
@retval (integer) number of mixes for requested channel
