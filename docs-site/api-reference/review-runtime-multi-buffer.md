...
- Unknown params to decide: `address`
- Use the selector table below. Your choices are saved into `docs-pipeline/generated/review-decisions.json`, which I can read later to patch the C++ `luadoc` block.

### Decision Controls

<div class="decision-panel" data-item-id="multiBuffer">
