...
- `docs-pipeline/overlays/<api-id>.md`
- preferably `docs-pipeline/overlays/<doc-id>.md` for stable page identity

Examples:

- `docs-pipeline/overlays/runtime.get-version.md`
- `docs-pipeline/overlays/lcd.drawBitmap.md`
