...
| Chapter | Content |
| --- | --- |
| [API Overview](api-overview/) | Covers various topics of Lua implementation in the EdgeTX operating system |
| [API Reference](api-reference/index.md) | Reference of all constants and functions available in the EdgeTX Lua API |
| [Programming](lua-api-programming/) | EdgeTX Lua programming guide that covers coding techniques with examples |
...
- For simple typos or proofreading, submit a PR to the [lua-reference-guide repository on GitHub](https://github.com/EdgeTX/lua-reference-guide/pulls).
...
Please visit [the OpenCollective page](https://opencollective.com/edgetx) if you would like to financially help support the project.
