...
Older OpenTX versions exposed less return data for this function. Keeping the example in the overlay allows the compatibility guidance to evolve without expanding the C++ source comments.
